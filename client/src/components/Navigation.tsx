...
export default function Navigation() {
  ...
  // Премахнахме "Събития" оттук, защото вече е отделна страница
  const navItems = [
    ...
    <nav className="sticky top-0 z-50 bg-white shadow-lg">
      <div className="container max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          {/* Нов линк към новата страница за Събития */}
          <Link href="/events">
            <button className="text-gray-700 hover:text-amber-600 transition-colors font-medium">Събития</button>
          </Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t p-4 space-y-2">
          ...
          <Link href="/events"><button className="block w-full text-left p-2 hover:bg-amber-50">Събития</button></Link>
